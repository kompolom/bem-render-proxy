import { FreezeMapper } from "../src/utils/freeze-map";
const WIN_MAP = {
...
describe("Freeze map", () => {
  ...
  it("Should return mapped url", () => {
    expect(mapperUnix.linkTo("bundles/admin/admin.css")).toBe(
      "static/KgEh9r54CSl.css"
    );
  });

  it("Should convert windows path to unix", () => {
    expect(mapperWin.linkTo("bundles/admin/admin.css")).toBe(
      "static/KgEh9r54CSl.css"
    );
  });
